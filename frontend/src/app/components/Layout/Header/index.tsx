...
// Hardcoded menu items (no fetch needed)
const headerData = [
  { label: 'Home', href: '/' },
  ...
  // Add 'Docs' if you have it: { label: 'Docs', href: '/docs' }
]
    ...
    >
      <div className="lg:py-0 py-2">
        <div className="container mx-auto max-w-(--breakpoint-xl) flex items-center justify-between px-4">
          ...
          >
            {/* Removed Sign In / Sign Up as per your request */}
            <button
        ...
        >
          ...
          <nav className="flex flex-col items-start p-4">
            ...
            {/* No Sign In/Sign Up in mobile menu */}
          </nav>
        </div>
      </div>
    </header>
